...
#ifndef SHARE_GC_TEST_TESTTHREADLOCALDATA_HPP
#define SHARE_GC_TEST_TESTTHREADLOCALDATA_HPP
...
private:
  ...
  static TestThreadLocalData* data(Thread* thread) {
    assert(UseTestGC, "Sanity");
    return thread->gc_data<TestThreadLocalData>();
  }

public:
  static void create(Thread* thread) {
    new (data(thread)) TestThreadLocalData();
  }

  static void destroy(Thread* thread) {
    data(thread)->~TestThreadLocalData();
  }
...
#endif // SHARE_GC_TEST_TESTTHREADLOCALDATA_HPP

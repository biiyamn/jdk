...
#ifndef SHARE_GC_TEST_TESTHEAP_HPP
#define SHARE_GC_TEST_TESTHEAP_HPP
...
class CollectedHeap;
class TestHeap : public CollectedHeap {
  friend class VMStructs;
private:
  SoftRefPolicy _soft_ref_policy;
  TestMonitoringSupport* _monitoring_support;
  MemoryPool* _pool;
...
public:
  static TestHeap* heap();

  TestHeap() :
          _memory_manager("Test Heap"),
          _space(nullptr) {};

  Name kind() const override {
    return CollectedHeap::Test;
  }
  ...
  size_t used()         const  { return _space->used(); }
...
#endif // SHARE_GC_TEST_TESTHEAP_HPP
